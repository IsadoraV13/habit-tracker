...
INSERT INTO habit (id, habit_name, user_id, reward_id, theme_id, difficulty_points)
VALUES
    (1, '3 x 3 push-ups', 1, 1, 1, 1),
--    (2, '1 x 20 of something difficult', 1, 1, 1, 1),
    (3, 'code for 2h', 1, 1, 2, 1);
